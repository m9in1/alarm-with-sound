...
set_property MARK_DEBUG true [get_nets {alarm/watch/counter_nsec_reg[6]_LDC_i_5_n_0}]

set_property MARK_DEBUG true [get_nets {alarm/Q[0]}]
set_property MARK_DEBUG true [get_nets {alarm/Q[1]}]
set_property MARK_DEBUG true [get_nets {alarm/Q[2]}]
set_property MARK_DEBUG true [get_nets {alarm/Q[3]}]
set_property MARK_DEBUG true [get_nets {alarm/Q[4]}]
set_property MARK_DEBUG true [get_nets {alarm/Q[5]}]
set_property MARK_DEBUG true [get_nets {alarm/cnt_sec[0]}]
set_property MARK_DEBUG true [get_nets {alarm/cnt_sec[1]}]
set_property MARK_DEBUG true [get_nets {alarm/cnt_sec[2]}]
set_property MARK_DEBUG true [get_nets {alarm/cnt_sec[3]}]
set_property MARK_DEBUG true [get_nets {alarm/cnt_sec[4]}]
set_property MARK_DEBUG true [get_nets {alarm/cnt_sec[5]}]
